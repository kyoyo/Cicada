			...
			element = $(settings.container);
						...
						jRecorderSettings = settings;
							...
							var paramStr = [
								...
								'<param name="csrfmiddlewaretoken" value="'+csrf_token+'" />',
							...
							// '<param name="csrfmiddlewaretoken" value="QpjSI9zqnTpouy166SPzyIdjlzulLfSu" />',
							createParam(htmlObj, "csrfmiddlewaretoken", csrf_token);
