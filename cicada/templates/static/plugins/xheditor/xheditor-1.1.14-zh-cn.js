...
var arrBlocktag=[{n:'p',t:'普通段落'},{n:'h1',t:'标题1'},{n:'h2',t:'标题2'},{n:'h3',t:'标题3'},{n:'h4',t:'标题4'},{n:'h5',t:'标题5'},{n:'h6',t:'标题6'},{n:'pre',t:'已编排格式'},{n:'address',t:'地址'},{n:'blockquote',t:'段落引用'}];
...
var arrTools={Code:{t:"插入代码"},Markdown:{"t":"使用Markdown语法"},OrderedList:{t:"有序列表"},UnorderedList:{t:"无序列表"},Blockquote:{t:"引用内容"},Record:{t:"插入语音"},Cut:{t:'剪切 (Ctrl+X)'},Copy:{t:'复制 (Ctrl+C)'},Paste:{t:'粘贴 (Ctrl+V)'},Pastetext:{t:'粘贴文本',h:isIE?0:1},Blocktag:{t:'段落标签',h:1},Fontface:{t:'字体',h:1},FontSize:{t:'字体大小',h:1},Bold:{t:'加粗 (Ctrl+B)',s:'Ctrl+B'},Italic:{t:'斜体 (Ctrl+I)',s:'Ctrl+I'},Underline:{t:'下划线 (Ctrl+U)',s:'Ctrl+U'},Strikethrough:{t:'删除线'},FontColor:{t:'字体颜色',h:1},BackColor:{t:'背景颜色',h:1},SelectAll:{t:'全选 (Ctrl+A)'},Removeformat:{t:'删除文字格式'},Align:{t:'对齐',h:1},List:{t:'列表',h:1},Outdent:{t:'减少缩进'},Indent:{t:'增加缩进'},Link:{t:'超链接 (Ctrl+L)',s:'Ctrl+L',h:1},Unlink:{t:'取消超链接'},Anchor:{t:'锚点',h:1},Img:{t:'图片',h:1},Flash:{t:'Flash动画',h:1},Media:{t:'多媒体文件',h:1},Hr:{t:'插入水平线'},Emot:{t:'表情',s:'ctrl+e',h:1},Table:{t:'表格',h:1},Source:{t:'源代码'},Preview:{t:'预览'},Print:{t:'打印 (Ctrl+P)',s:'Ctrl+P'},Fullscreen:{t:'全屏编辑 (Esc)',s:'Esc'},About:{t:'关于 xhEditor'}};
var toolsThemes={
...
var xheditor=function(textarea,options)
{
	...
	this.init=function()
	{
		...
		$.each(settings.tools,function(i,n)
		{
			...
			else
			{
				...
				arrToolsHtml.push('<span class="btn-'+n+'"><a href="#" title="'+tool.t+'" cmd="'+n+'" class="xheButton xheEnabled" tabindex="-1" role="button"><span class="'+cn+'" unselectable="on" style="font-size:0;color:transparent;text-indent:-999px;">'+tool.t+'</span></a></span>');
	...
	this.showDialog=function(content,bNoFocus)
	{
		...
		if(jSave.length===1)
		{
			...
			jSave.after(' <input type="button" id="xheCancel" class="btn btn-small" value="取消" />');
	...
	this.exec=function(cmd)
	{
		...
		else//内置工具
		{
			...
			{
				case 'orderedlist':
					_this._exec('insertOrderedList');
					break;
				case 'unorderedlist':
					_this._exec('insertUnorderedList');
					break;
				// case 'blockquote':
